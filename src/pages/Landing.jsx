...
const Landing = () => {
  ...
  const handleGoogleAuth = () => {
    console.log(`Google ${isSignUp ? "signup" : "login"} clicked`);
    // Add Google auth logic here
  };

  const handleAppleAuth = () => {
    console.log(`Apple ${isSignUp ? "signup" : "login"} clicked`);
    // Add Apple auth logic here
  };
  ...
  return (
    <div>
      ...
      <div className="body-container">
        <section
          className={`form-section ${isTransitioning ? "transitioning" : ""}`}
        >
          <div className="form-container">
            ...
            {/* Remember Me and Forget Password - only shown in login mode */}
            {!isSignUp && (
            ...
            <button type="button" onClick={handleSubmit} className="auth-btn">
                ...
                >
                  <svg viewBox="0 0 32 32" className="social-icon">
                    <g transform="translate(1.000000, 1.000000)">
                      <path
                        fill="#000000"
                        d="M10.7,31C10.7,31,10.7,31,10.7,31c-2.6,0-4.4-2.3-5.7-4.3c-3.3-5.1-4-11.5-1.6-15.2c1.6-2.5,4.2-4,6.7-4
                      ...
                      <path
                        fill="#000000"
                        d="M14.7,7.7c-0.1,0-0.1,0-0.2,0c-0.5,0-0.9-0.4-1-0.8c-0.3-1.7,0.3-3.7,1.6-5.3c1.2-1.5,3.2-2.5,5-2.7c0.5,0,1,0.3,1.1,0.9
